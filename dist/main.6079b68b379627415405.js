...
`;t.default=function(){const{cartItems:e,price:t,discountPrice:n}=r.useSelector(e=>e.cart);return o.createElement(d,null,e.length>=1?o.createElement(o.Fragment,null,o.createElement(u,null,e.map(e=>o.createElement(c.default,Object.assign({key:e.id},e)))),o.createElement(m,null,o.createElement(g,null,o.createElement(_,null,"상품 금액"),o.createElement(C,null,s.numberWithComma(t),"원")),o.createElement(g,null,o.createElement(_,null,"할인 금액"),o.createElement(C,null,s.numberWithComma(n),"원")),o.createElement(g,null,o.createElement(_,null,"총 금액"),o.createElement(C,null,s.numberWithComma(t-n),"원")),o.createElement(O,{onClick:()=>alert(`총 금액 ${s.numberWithComma(t-n)} 원 구매 완료`)},"구매하기"))):o.createElement(p,null,o.createElement(f,null),"장바구니가 비어있습니다."),o.createElement(l.default,null))}},,,function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=n(7),a=n(25),c=n(13),l=n(11),s=n(14),d=i.default.div`
    position: relative;
    display: flex;
...
`,I=i.default.div`
    ...
    margin-right: 8px;
`;t.default=function({id:e,title:t,coverImage:n,price:i,score:a,availableCoupon:L=!0,amount:D,isSelected:j=!1,coupon:w}){const M={id:e,title:t,coverImage:n,price:i,score:a,availableCoupon:L,amount:D,isSelected:j,coupon:w},F=r.useDispatch();return o.createElement(d,null,o.createElement(m,{onClick:()=>F(c.removeProductFromCart(M))},o.createElement(g,null)),o.createElement(u,null,o.createElement(I,null,o.createElement(U,null),o.createElement(S,{isSelected:j,onClick:()=>F(c.selectProductAtCart(e))},o.createElement(A,{viewBox:"0 0 24 24"},o.createElement("polyline",{points:"20 6 9 17 4 12"})))),o.createElement(p,{backgroundColor:"#000000"},o.createElement(f,{color:"#ffffff"},a,"명의 선택")),L&&o.createElement(p,{backgroundColor:"red"},o.createElement(f,{color:"#ffffff"},"쿠폰 적용 가능"))),o.createElement(_,{src:n}),o.createElement(C,null,o.createElement(O,null,t),o.createElement(E,null,o.createElement(b,null,s.numberWithComma(i),"원"),o.createElement(x,null,o.createElement(P,{disabled:D<=1,onClick:()=>F(c.decreaseCartProductAmount(e))},"-"),o.createElement(T,null,D),o.createElement(P,{onClick:()=>F(c.increaseCartProductAmount(e))},"+")))),o.createElement(h,null),o.createElement(v,null,o.createElement(R,{disabled:!L||Boolean(w),availableCoupon:L,onClick:()=>F(l.openCouponModalDialog(e))},L?Boolean(w)?w.title:"쿠폰 적용하기":"쿠폰 적용 불가"),o.createElement(y,null,"총 ",s.numberWithComma(i*D)," 원")))}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(7),r=n(5),a=n(19),c=n(52),l=n(11),s=n(26),d=r.default.div`
...
`,O=r.default.div`
    ...
    text-align: center;
    margin: 15px;
`;t.default=function(){const e=i.useDispatch(),{cartItems:t}=i.useSelector(e=>e.cart),{loading:n,isOpen:r,coupons:a,error:h}=i.useSelector(e=>e.coupon);return o.useEffect(()=>{r&&e(s.getCouponList(t))},[r]),r&&o.createElement(d,null,o.createElement(u,null,o.createElement(p,null,o.createElement(m,{onClick:()=>e(l.closeCouponModalDialog())},o.createElement(f,null))),o.createElement(g,null,n?o.createElement(_,null,o.createElement(C,null),o.createElement(O,null,"Loading...")):a.map(e=>o.createElement(c.default,Object.assign({},e))))))}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=n(7),a=n(14),c=n(13),l=n(11),s=i.default.div`
    width: 80%;
    height: 80px;
...
`,f=i.default.img`
    width: 150px;
    height: auto;
`;t.default=a.withRouter((function({location:{pathname:e}}){const{cartItemCounts:t}=r.useSelector(e=>e.cart);return o.createElement(l,null,o.createElement(p,null,o.createElement(f,{src:c.default})),o.createElement(s,null,o.createElement(d,{current:"/"===e},o.createElement(u,{to:"/"},"HOME")),o.createElement(d,{current:"/products"===e},o.createElement(u,{to:"/products"},"PRODUCTS")),o.createElement(d,{current:"/cart"===e},o.createElement(u,{to:"/cart"},"CART (",t,")"))))}))},function(e,t,n){"use strict";n.r(t),t.default=n.p+"images/logo.png"},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=n(7),a=n(27),c=n(60),l=n(61),s=n(62),d=n(26),u=i.default.div`
    width: 80%;
    height: auto;
    margin: 0 auto;
...
`,p=i.default.ul`
    ...
    padding: 30px;
    text-align: center;
`;t.default=function(){const e=r.useDispatch(),{loading:t,productItems:n,currentPage:i,itemCounts:f}=r.useSelector(e=>e.product),{cartItems:m}=r.useSelector(e=>e.cart);return o.useEffect(()=>{e(d.getProductList(i))},[i]),o.createElement(u,{className:"route-container"},o.createElement(a.default,{title:"PRODUCT"}),o.createElement(p,null,n.map(e=>o.createElement(s.default,Object.assign({key:e.id,isInCart:m.some(t=>t.id===e.id)},e))),o.createElement(l.default,{currentPage:i,range:Math.ceil(f/5)})),o.createElement(c.default,{isLoading:t}))}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=i.default.div`
    background-color: rgba(0, 0, 0, 0.6);
...
`,c=i.default.div`
    ...
    color: #fff;
    margin: 15px;
`;t.default=function({isLoading:e}){return o.createElement(r,{isLoading:e},o.createElement(a,null),o.createElement(c,null,"Loading..."))}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=n(7),a=n(20),c=i.default.div`
    width: 100%;
    height: 40px;
    display: flex;
    justify-content: center;
...
`;t.default=function({currentPage:e,range:t}){const n=r.useDispatch();let i=null;switch(!0){case t<7:i=[...new Array(t)].map((e,t)=>t+1);break;case e<4:i=[1,2,3,4,5,"...",t];break;case e>t-4:i=[1,"...",t-4,t-3,t-2,t-1,t];break;default:i=[1,"...",e-1,e,e+1,"...",t]}return 0!==t&&o.createElement(c,null,o.createElement(l,{disabled:e<=1,onClick:()=>n(a.changeProductListCurrentPage(e-1)),isActive:!1,isFirst:1===e,isLast:!1},"<"),i.map(t=>o.createElement(l,{key:t,disabled:"..."===t,onClick:()=>"number"==typeof t&&n(a.changeProductListCurrentPage(t)),isActive:e===t,isFirst:!1,isLast:!1},t)),o.createElement(l,{disabled:e>=t,onClick:()=>n(a.changeProductListCurrentPage(e+1)),isActive:!1,isFirst:!1,isLast:e===t},">"))}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(1),i=n(5),r=n(7),a=n(63),c=n(19),l=n(64),s=n(25),d=n(13),u=n(14),p=i.default.li`
    display: inline-flex;
    min-width: 30%;
    flex: 1;
    height: auto;
...
`,R=i.default(a.FaCartPlus)`
    display: inline-block;
    width: 1rem;
    height: 1rem;
    fill: #ffffff;
    margin-right: 4px;
`,y=i.default(s.MdRemoveShoppingCart)`
    display: inline-block;
    width: 1rem;
    height: 1rem;
    fill: #ffffff;
    margin-right: 4px;
`;t.default=function({id:e,title:t,coverImage:n,price:i,score:a,availableCoupon:c=!0,isInCart:l=!1}){const s={id:e,title:t,coverImage:n,price:i,score:a,availableCoupon:c,amount:1,isSelected:!1},{cartItemCounts:U}=r.useSelector(e=>e.cart),A=r.useDispatch();return o.createElement(p,null,o.createElement(f,null,o.createElement(m,{src:n,className:"product-image"})),o.createElement(g,null,o.createElement(_,null,t),o.createElement(C,null,o.createElement(O,null),o.createElement(h,null,a)),o.createElement(T,null),o.createElement(E,null,o.createElement(b,null,o.createElement(x,{availableCoupon:c,color:"rgb(27, 28, 29)"},u.numberWithComma(i),"원"),c&&o.createElement(o.Fragment,null,o.createElement(P,null),o.createElement(x,{availableCoupon:!1,color:"red"},"쿠폰 적용 가능"))),o.createElement(v,{onClick:l?()=>A(d.removeProductFromCart(s)):()=>A(d.addProductToCart(s)),isPointer:l||U<3},l?o.createElement(o.Fragment,null,o.createElement(y,null),"카트에서 빼기"):o.createElement(o.Fragment,null,o.createElement(R,null),U>=3?"카드가 가득참":"카드에 담기")))))}},,,function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(66),i=n(5).createGlobalStyle`
    ${o.default};
    *,
    *::after,
    *::before {
...
`;t.default=i},,function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(68),i=n(12),r=(n(69),n(70)),a=i.createStore(r.default,i.applyMiddleware(o.default));t.default=a},,,function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(12),i=n(71),r=n(72),a=n(74),c=o.combineReducers({product:i.default,cart:r.default,coupon:a.default});t.default=c},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(20),i=n(10).createReducer({loading:!1,currentPage:1,productItems:[],itemCounts:0,error:null},{[o.FETCH_PRODUCT_LIST_REQUEST]:e=>Object.assign(Object.assign({},e),{loading:!0}),[o.FETCH_PRODUCT_LIST_SUCCESS]:(e,t)=>Object.assign(Object.assign(Object.assign({},e),{loading:!1}),t.payload),[o.FETCH_PRODUCT_LIST_FAILURE]:(e,t)=>Object.assign(Object.assign({},e),{loading:!1,error:t.payload}),[o.CHANGE_PRODUCT_LIST_CURRENT_PAGE]:(e,t)=>Object.assign(Object.assign({},e),{currentPage:t.payload})});t.default=i},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(13),i=n(10),r=n(73),a=i.createReducer({cartItemCounts:0,cartItems:[],price:0,discountPrice:0,error:null},{[o.ADD_PRODUCT_TO_CART]:(e,t)=>e.cartItemCounts>=3?e:Object.assign(Object.assign({},e),{cartItems:[...e.cartItems,t.payload],cartItemCounts:e.cartItemCounts+1}),[o.REMOVE_PRODUCT_FROM_CART]:(e,t)=>{const n=t.payload;return Object.assign(Object.assign({},e),{cartItems:[...e.cartItems.filter(e=>e.id!==n.id)],cartItemCounts:e.cartItemCounts-1,price:e.price-n.price*n.amount,discountPrice:e.discountPrice-(n.coupon?r.applyCoupon(n.price,n.amount,n.coupon):0)})},[o.INCREASE_CART_PRODUCT_AMOUNT]:(e,t)=>{let n;const o=e.cartItems.map(e=>e.id===t.payload?(n=e,Object.assign(Object.assign({},e),{amount:e.amount+1})):Object.assign({},e));return Object.assign(Object.assign({},e),{cartItems:o,price:e.price+(n.isSelected?n.price:0),discountPrice:e.discountPrice+(n.coupon&&n.isSelected?r.applyCoupon(n.price,1,n.coupon):0)})},[o.DECREASE_CART_PRODUCT_AMOUNT]:(e,t)=>{let n;const o=e.cartItems.map(e=>e.id===t.payload?(n=e,Object.assign(Object.assign({},e),{amount:e.amount-1})):Object.assign({},e));return Object.assign(Object.assign({},e),{cartItems:o,price:e.price-(n.isSelected?n.price:0),discountPrice:e.discountPrice-(n.coupon&&n.isSelected?r.applyCoupon(n.price,1,n.coupon):0)})},[o.SELECT_PRODUCT_AT_CART]:(e,t)=>{const n=e.cartItems.find(e=>e.id===t.payload),o=e.cartItems.map(e=>e.id===t.payload?Object.assign(Object.assign({},e),{isSelected:!e.isSelected}):Object.assign({},e)),i=n.coupon?r.applyCoupon(n.price,n.amount,n.coupon):0;return Object.assign(Object.assign({},e),{cartItems:o,price:e.price+(n.isSelected?-n.price*n.amount:n.price*n.amount),discountPrice:e.discountPrice+(n.isSelected?-i:i)})},[o.ADD_COUPON_AT_PRODUCT]:(e,t)=>{const n=Object.assign(Object.assign({},e.cartItems.find(e=>e.id===t.payload.productId)),{isSelected:!0,coupon:t.payload.coupon});return Object.assign(Object.assign({},e),{cartItems:e.cartItems.map(e=>e.id===t.payload.productId?Object.assign({},n):Object.assign({},e)),price:e.price+n.price*n.amount,discountPrice:e.discountPrice+r.applyCoupon(n.price,n.amount,t.payload.coupon)})},[o.REMOVE_COUPON_FROM_PRODUCT]:(e,t)=>{const n=e.cartItems.find(e=>e.id===t.payload.productId);return Object.assign(Object.assign({},e),{cartItems:e.cartItems.map(e=>e.id===t.payload.productId?Object.assign(Object.assign({},n),{coupon:null}):Object.assign({},e)),discountPrice:e.discountPrice-r.applyCoupon(n.price,n.amount,t.payload.coupon)})}});t.default=a},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.applyCoupon=void 0,t.applyCoupon=function(e,t,n){const{type:o,discountRate:i,discountAmount:r}=n;return"rate"===o?Math.floor(e*t/i):r*t}},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const o=n(11),i=n(10).createReducer({loading:!1,isOpen:!1,coupons:[],selectedProductId:"",error:null},{[o.ADD_COUPON_TO_LIST]:(e,t)=>Object.assign(Object.assign({},e),{coupons:[...e.coupons,t.payload]}),[o.REMOVE_COUPON_FROM_LIST]:(e,t)=>Object.assign(Object.assign({},e),{coupons:[...e.coupons.filter(e=>e.title!==t.payload.title)]}),[o.FETCH_COUPON_LIST_REQUEST]:e=>Object.assign(Object.assign({},e),{loading:!0}),[o.FETCH_COUPON_LIST_SUCCESS]:(e,t)=>Object.assign(Object.assign(Object.assign({},e),{loading:!1}),t.payload),[o.FETCH_COUPON_LIST_FAILURE]:(e,t)=>Object.assign(Object.assign({},e),{loading:!1,error:t.payload}),[o.OPEN_COUPON_MODAL_DIALOG]:(e,t)=>Object.assign(Object.assign({},e),{isOpen:!0,selectedProductId:t.payload}),[o.CLOSE_COUPON_MODAL_DIALOG]:e=>Object.assign(Object.assign({},e),{isOpen:!1,selectedProductId:""})});t.default=i}]);